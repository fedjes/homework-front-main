...
export const HW2 = () => {
  ...
  const filterUsers = () => {
    ...
    const filteredUsers = users.myFriends.filter( (f)=> {return f.address.city === 'Los Angeles'}) //'НУЖНО ПРОФИЛЬТРОВАТЬ ДРУЗЕЙ. ОСТАВЛЯЕМ ТОЛЬКО ТЕХ, КОТОРЫЕ ЖИВУТ В ГОРОДЕ LOS ANGELES';
